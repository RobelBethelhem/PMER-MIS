    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-[#0F172A]">
      ...
      <div className="relative z-10 w-full max-w-md mx-4">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-3xl bg-white/10 backdrop-blur-xl border border-white/10 shadow-2xl shadow-rose-500/20 mb-6">
            <Shield className="w-10 h-10 text-[#E11D48]" strokeWidth={2.5} />
          </div>
          <h1
