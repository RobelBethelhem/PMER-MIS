...
<<<<<<< HEAD
        ...
        className,
=======
        "z-50 min-w-[8rem] overflow-hidden rounded-md border bg-white p-1 text-slate-900 shadow-md animate-in fade-in-0 zoom-in-95",
        className
>>>>>>> e0b16a6 (commit)
      )}
      {...props}
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn("relative flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none transition-colors focus:bg-slate-100 focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50", inset && "pl-8", className)}
>>>>>>> e0b16a6 (commit)
    {...props}
  />
));
